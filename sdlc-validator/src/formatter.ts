...
import { WorkspaceValidationResult, FolderValidationResult, FileValidationResult, Issue } from './validator';

export function formatWorkspaceResults(result: WorkspaceValidationResult): string {
  const lines: string[] = [];
...
function formatFolderResult(result: FolderValidationResult): string[] {
  const lines: string[] = [];
  const statusIcon = result.passed ? '✅' : '❌';
...
function formatFileResult(result: FileValidationResult): string[] {
  const lines: string[] = [];
...
export function formatSingleFileResult(result: FileValidationResult): string {
  const lines: string[] = [];
  const statusIcon = result.passed ? '✅' : '❌';
